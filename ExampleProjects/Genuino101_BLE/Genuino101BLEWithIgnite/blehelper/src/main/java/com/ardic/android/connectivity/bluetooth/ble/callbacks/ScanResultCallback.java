...
public class ScanResultCallback {
    ...
    private static final String TAG = ScanResultCallback.class.getSimpleName();
    ...
    private ScanCallback mScanCallback = new ScanCallback() {
        ...
        public void onScanResult(int callbackType, ScanResult result) {
            ...
            Log.i(TAG,"Result arrived. Device :" + result.getDevice().getName());
            if(listener!=null) {
        ...
        public void onBatchScanResults(List<ScanResult> results) {
            ...
            Log.i(TAG,"Results arrived. Device Size :" + results.size());
            if(listener!=null) {
